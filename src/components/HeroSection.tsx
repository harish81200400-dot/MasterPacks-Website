...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenCheckout, currency }) => {
  ...
  return (
    <header className="relative px-4 sm:px-6 pt-16 sm:pt-20 pb-2 text-center max-w-5xl mx-auto flex flex-col items-center">
