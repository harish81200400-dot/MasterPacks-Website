...
export const LibraryBonus: React.FC<LibraryBonusProps> = ({ onOpenCheckout, currency }) => {
  return (
    <section id="library" className="py-20 px-6 bg-slate-900 border-t border-slate-800 scroll-mt-20">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-slate-400 mb-12 text-base md:text-lg max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16 text-left">
          ...
          <div className="bg-slate-800 p-8 rounded-3xl border border-slate-700 hover:border-blue-500/60 transition-all shadow-xl">
            <div className="w-12 h-12 rounded-2xl bg-blue-500/10 text-blue-400 flex items-center justify-center font-bold text-2xl mb-4 border border-blue-500/20">
              📜
            </div>
            <h3 className="text-2xl font-extrabold mb-4 text-blue-400">Documentary Assets</h3>
          ...
          {/* SaaS Promo Card */}
          <div className="bg-slate-800 p-8 rounded-3xl border border-slate-700 hover:border-purple-500/60 transition-all shadow-xl">
            <div className="w-12 h-12 rounded-2xl bg-purple-500/10 text-purple-400 flex items-center justify-center font-bold text-2xl mb-4 border border-purple-500/20">
              🚀
            </div>
            <h3 className="text-2xl font-extrabold mb-4 text-purple-400">SaaS Promo</h3>
            <ul className="space-y-3 text-slate-300 font-medium text-base">
              <li className="flex items-center gap-2.5">
        ...
        {/* BONUS VAULT BANNER */}
        <div className="bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-900 p-8 md:p-12 rounded-3xl border border-purple-500/50 relative overflow-hidden shadow-2xl">
